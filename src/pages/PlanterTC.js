...
export default function PlanterTC() {
  return (
    <Container>
      ...
      <p>
        Oscillator stores and processes personal data that you have provided to us as a data controller, in order to provide our Service. More information about data processing is available in the Privacy Policy under the address: <Link to={ROUTES.PLANTER_PRIVACY_POLICY}> Privacy Policy - Planter</Link>.
      </p>
