...
import EmailPrivate from '../components/EmailPrivate.js';

export default function HourglassPrivacyPolicy() {
  return (
    <Container>
      ...
      <h2>Contact Us</h2>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at the email: <EmailPrivate />
      </p>
