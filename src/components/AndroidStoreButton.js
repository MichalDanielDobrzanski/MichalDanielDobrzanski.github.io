...
export default class AndroidStoreButton extends React.Component {
    render() {
        const androidUrl = 'https://play.google.com/store/apps/details?id=com.oscillator.planter.prod';
        return (
            <a href={androidUrl}>
                <GooglePlayStoreIcon />
            </a>
